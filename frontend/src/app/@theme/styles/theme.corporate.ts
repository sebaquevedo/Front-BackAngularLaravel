export const CORPORATE_THEME = {
  ...
  variables: {
    ...
    visitors: {
      ...
      innerAreaGradFrom: '#ff6e42',
      innerAreaGradTo: '#ff906e',
    },
    ...
    visitorsPie: {
      firstPieGradientLeft: '#005cff',
      firstPieGradientRight: '#005cff',
      firstPieShadowColor: 'rgba(0, 0, 0, 0)',
      firstPieRadius: ['65%', '90%'],

      secondPieGradientLeft: '#FF3d00',
      secondPieGradientRight: '#FF3d00',
      secondPieShadowColor: '#ff906e',
